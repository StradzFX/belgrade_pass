...
class cl_pass_rules implements base_domain_object
{
	public $id = 0;
	...
	{
		$new_object = new cl_pass_rules($row['id'],$row['training_school'],$row['ts_location'],$row['hours_from'],$row['minutes_from'],$row['hours_to'],$row['minutes_to'],$row['pass_per_kid'],$row["maker"],$row["makerDate"],$row["checker"],$row["checkerDate"],$row["pozicija"],$row["jezik"],$row["recordStatus"],$row["modNumber"],$row["multilang_id"]);
