...
class seo_configuration implements base_domain_object
{
	public $id = 0;
	public $page = "";
	public $image = "";
	...
	private $varchar = array("page","image","title","keyword","description","type","maker","makerDate","checker","checkerDate","jezik","recordStatus");

	private $display_elements_formats = array();
	public $format_options = NULL; 
	
	//Constructor and Domain name
	public function __construct($id = 0, $page = "", $image = "", $title = "", $keyword = "", $description = "", $type = "", $maker = "",$makerDate = "",$checker = "",$checkerDate = "",$pozicija="",$jezik="",$recordStatus="",$modNumber="",$multilang_id = 0)
	{
		$this->id = $id;
		$this->page = $page;
		$this->image = $image;
	...
	$this->display_elements_formats["image"] = array("database_type"=>"VARCHAR","html_type"=>"IMAGE");
	$this->display_elements_formats["title"] = array("database_type"=>"VARCHAR","html_type"=>"INPUT");
	$this->display_elements_formats["keyword"] = array("database_type"=>"VARCHAR","html_type"=>"INPUT");
	$this->display_elements_formats["description"] = array("database_type"=>"TEXT","html_type"=>"INPUT");
	$this->display_elements_formats["type"] = array("database_type"=>"VARCHAR","html_type"=>"INPUT");
	...
	public function get_attribute_list()
	{
		...
		return "`id`,`page`,`image`,`title`,`keyword`,`description`,`type`,`maker`,`makerDate`,`checker`,`checkerDate`,`pozicija`,`jezik`,`recordStatus`,`modNumber`,`multilang_id`";
	}

	public function get_attribute_values()
	{
		return "NULL,'{$this->page}','{$this->image}','{$this->title}','{$this->keyword}','{$this->description}','{$this->type}','{$this->maker}','{$this->makerDate}','{$this->checker}','{$this->checkerDate}',{$this->pozicija},'{$this->jezik}','{$this->recordStatus}','{$this->modNumber}','{$this->multilang_id}'";
	}
	
	public function get_object($row)
	{
		$new_object = new seo_configuration($row['id'],$row['page'],$row['image'],$row['title'],$row['keyword'],$row['description'],$row['type'],$row["maker"],$row["makerDate"],$row["checker"],$row["checkerDate"],$row["pozicija"],$row["jezik"],$row["recordStatus"],$row["modNumber"],$row["multilang_id"]);
