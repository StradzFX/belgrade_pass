jQuery( document ).ready( function( $ ) {
	...
	$( document ).on( 'click', '#woo_vou_qrcode_btn', function() {
		jQuery('.woo_vou_builder_area').hide();
		jQuery('.woo_vou_controls').append( '<div class="woo_vou_controls_editor text_column qrcodeblock full_width draghandle" style="background-color:#FFFFFF;"><div class="woo_vou_controller"><a class="woo_vou_lesser_width" href="javascript:void(0);"></a><span class="width_size">1/1</span><a class="woo_vou_greater_width" href="javascript:void(0);"></a><a class="woo_vou_change editqrcode" href="javascript:void(0);"></a><a class="woo_vou_remove" href="javascript:void(0);"></a></div><div class="woo_vou_text"><p>'+WooVouQrcodeBlock.qrcodeblockdesc+'</p></div><input type="hidden" value="full_width" class="woo_vou_txtclass_width" id="woo_vou_custom_width" name="woo_vou_text_width"><input type="hidden" class="woo_vou_qrcode_width" id="woo_vou_qrcode_width" name="woo_vou_qrcode_width" value=""><input type="hidden" class="woo_vou_qrcode_height" id="woo_vou_qrcode_height" name="woo_vou_qrcode_height" value=""><input type="hidden" class="woo_vou_qrcode_color" id="woo_vou_qrcode_color" name="woo_vou_qrcode_color" value=""><input type="hidden" class="woo_vou_qrcode_border" id="woo_vou_qrcode_border" name="woo_vou_qrcode_border" value="1"><input type="hidden" class="woo_vou_qrcode_response" id="woo_vou_qrcode_response" name="woo_vou_qrcode_response" value="url"></div>' );
			if(typeof(Prototype) != "undefined")  {
   				portal = new Portal(settings, options, data);
  			}
		return false;
	...
	$( document ).on( 'click', '#woo_vou_qrcodes_btn', function() {
		jQuery('.woo_vou_builder_area').hide();
		jQuery('.woo_vou_controls').append( '<div class="woo_vou_controls_editor text_column qrcodesblock full_width draghandle" style="background-color:#FFFFFF;"><div class="woo_vou_controller"><a class="woo_vou_lesser_width" href="javascript:void(0);"></a><span class="width_size">1/1</span><a class="woo_vou_greater_width" href="javascript:void(0);"></a><a class="woo_vou_change editqrcodes" href="javascript:void(0);"></a><a class="woo_vou_remove" href="javascript:void(0);"></a></div><div class="woo_vou_text"><p>'+WooVouQrcodesBlock.qrcodesblockdesc+'</p></div><input type="hidden" value="full_width" class="woo_vou_txtclass_width" id="woo_vou_custom_width" name="woo_vou_text_width"><input type="hidden" class="woo_vou_qrcode_width" id="woo_vou_qrcode_width" name="woo_vou_qrcode_width" value=""><input type="hidden" class="woo_vou_qrcode_height" id="woo_vou_qrcode_height" name="woo_vou_qrcode_height" value=""><input type="hidden" class="woo_vou_qrcode_color" id="woo_vou_qrcode_color" name="woo_vou_qrcode_color" value=""><input type="hidden" class="woo_vou_qrcode_type" id="woo_vou_qrcode_type" name="woo_vou_qrcode_type" value="vertical"><input type="hidden" class="woo_vou_qrcode_border" id="woo_vou_qrcode_border" name="woo_vou_qrcode_border" value="1"><input type="hidden" class="woo_vou_qrcode_response" id="woo_vou_qrcode_response" name="woo_vou_qrcode_response" value="url"></div>' );
			if(typeof(Prototype) != "undefined")  {
   				portal = new Portal(settings, options, data);
  			}
		return false;
		...
		jQuery(".text_column").each(function(index) {
			...
			if($(this).closest('.text_column').hasClass('textblock')) { // shortcode for voucher code
				...
				pbrshortcodes += '[woo_vou_qrcodes';
					...
					if(qrcode_type != '' && qrcode_type != 'undefined') {
						pbrshortcodes += ' qrcode_type="'+qrcode_type+'"';
					}
					if(qrcode_border != '' && qrcode_border != 'undefined') {
						pbrshortcodes += ' qrcode_border="'+qrcode_border+'"';
					}
