...
class WOO_Vou_Shortcodes {
	...
	public function woo_vou_qrcode_code( $atts, $content ) {
		...
		$content = $this->model->woo_vou_qrcode_html( $pdf_template_id, $pdf_voucodes, $arguments );
	...
	public function woo_vou_barcode_code( $atts, $content ) {
		...
		$content = $this->model->woo_vou_barcode_html( $pdf_template_id, $pdf_voucodes, $arguments );
