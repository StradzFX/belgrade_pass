...
if ( !defined( 'ABSPATH' ) ) exit;
	...
	$metastring .= '<input type="hidden" id="woo_vou_editor_status" name="'.$prefix.'editor_status" value="'.$woo_vou_status.'">
					<div id="woo_vou_main_editor" class="woo_vou_main_editor" style="display:block;">
						...
						<span class="woo_vou_tooltip"><a href="javascript:void(0);" class="woo_vou_main_buttons" id="woo_vou_qrcode_btn" name="woo_vou_qrcode_btn"><div class="woo_vou_qrcode_btn"></div></a><span class="woo_vou_classic">' . __( 'Click to add a QRCode Block', 'woovoucher' ) . '</span></span>
						<span class="woo_vou_tooltip"><a href="javascript:void(0);" class="woo_vou_main_buttons" id="woo_vou_qrcodes_btn" name="woo_vou_qrcodes_btn"><div class="woo_vou_qrcodes_btn"></div></a><span class="woo_vou_classic">' . __( 'Click to add a QRCodes Block', 'woovoucher' ) . '</span></span>
						<span class="woo_vou_tooltip"><a href="javascript:void(0);" class="woo_vou_main_buttons" id="woo_vou_barcode_btn" name="woo_vou_barcode_btn"><div class="woo_vou_barcode_btn"></div></a><span class="woo_vou_classic">' . __( 'Click to add a Barcode Block', 'woovoucher' ) . '</span></span>
						<span class="woo_vou_tooltip"><a href="javascript:void(0);" class="woo_vou_main_buttons" id="woo_vou_barcodes_btn" name="woo_vou_barcodes_btn"><div class="woo_vou_barcodes_btn"></div></a><span class="woo_vou_classic">' . __( 'Click to add a Barcodes Block', 'woovoucher' ) . '</span></span>';
