	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		...
		<div class="footer-text-area">
			...
			<div class="theme-info">
				<a href="<?php echo esc_url( esc_html__( 'https://wordpress.org/', 'listable' ) ); ?>"><?php printf( esc_html__( ' %s', '' ), '' ); ?></a>
				<span class="sep"> <?php _e( '', '' ) ?> </span>
				<?php printf( esc_html__( '%1$s  %2$s.', '' ), '<a href="http://themeforest.net/item/listable-a-friendly-directory-wordpress-theme/13398377?ref=pixelgrade" rel="theme"></a>', '<a href="https://pixelgrade.com/" rel="designer"></a>' ); ?>
			</div>
		</div>
	</footer><!-- #colophon -->
</div><!-- #page -->
