	...
	<header id="masthead" class="site-header" role="banner">
		<div class="site-branding  site-branding--image">
			<a href="" class="custom-logo-link" rel="home" itemprop="url">
				<img width="130" height="130" src="wp-content/uploads/2017/07/246522_318032038284304_1207326296_n.jpg" class="custom-logo" alt="" itemprop="logo" />
			</a>
		</div>
		...
		<nav id="site-navigation" class="menu-wrapper" role="navigation">
			...
			<ul id="menu-main-menu" class="primary-menu header-menu">
				...
				<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-11136">
					<a href="profile/" class=" ">Moj nalog</a>
					<ul  class="sub-menu">
