        ...
        <tbody>
          <?php for ($i=0; $i < sizeof($transactions_all); $i++) { ?>
            <tr>
              ...
              <td class="<?php echo $transactions_all[$i]->status_css; ?>"><?php echo $transactions_all[$i]->status; ?></td>
              <td><?php echo $transactions_all[$i]->display_date; ?></td>
              <td><a href="transakcija/<?php echo $transactions_all[$i]->purchase->id; ?>" class="btn btn-xs">Vidi detalje</a></td>
            </tr>
          <?php } ?>
