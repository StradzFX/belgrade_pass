...
//================ ERROR HANDLER - INPUT|INPUT READONLY|DROPMENUEXT|DROPMENUPARENT ELEMENT - Trainer
	...
	if($error_message == "")
	{
		...
		$new_object = new ts_programm();
		$new_object->training_school = $training_school;$new_object->ts_location = $ts_location;$new_object->name = $name;$new_object->age_from = $age_from;$new_object->age_to = $age_to;$new_object->trainer = $trainer;$new_object->maker = $_SESSION[ADMINLOGGEDIN];
		...
		if($new_dc_id > 0)
		{
			...
			$broker->insert(new xenon_dataaudittrail(0,$_SERVER["REMOTE_ADDR"],date("Y-m-d H:i:s"),$_SESSION[ADMINLOGGEDIN],"ts_programm","new",$new_dc_id));
...
if($error_message != "")
{
	...
	if(isset($_POST["promote"]))	$ts_programm->checker = $_SESSION[ADMINLOGGEDIN];
	else							$ts_programm->checker = "";
}
else	unset($ts_programm);
?>
<div id="container">
	<div id="top">
	<h1><?php echo $ap_lang["New"]; ?> - TS Programm</h1>
