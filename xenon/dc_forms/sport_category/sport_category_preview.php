...
$sec_to_min = new sport_category();
$sec_to_min->condition = $dc_objects->condition;
$sec_to_min->order_by = $dc_objects->order_by;
$sec_to_min->add_condition("pozicija","<",$sport_category->pozicija);
...
$sec_to_max = new sport_category();
$sec_to_max->condition = $dc_objects->condition;
$sec_to_max->order_by = $dc_objects->order_by;
$sec_to_max->add_condition("pozicija",">",$sport_category->pozicija);
...
<div id="container">
	<div id="top">
	<h1><?php echo $ap_lang["Preview"]; ?> - Category</h1>
