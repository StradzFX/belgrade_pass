...
require_once "../classes/domain/company_events.class.php";
...
$sec_to_min = new company_events();
$sec_to_min->condition = $dc_objects->condition;
$sec_to_min->order_by = $dc_objects->order_by;
$sec_to_min->add_condition("pozicija","<",$company_events->pozicija);
...
$sec_to_max = new company_events();
$sec_to_max->condition = $dc_objects->condition;
$sec_to_max->order_by = $dc_objects->order_by;
$sec_to_max->add_condition("pozicija",">",$company_events->pozicija);
...
<div id="container">
	<div id="top">
	<h1><?php echo $ap_lang["Preview"]; ?> - Company periods</h1>
