...
require_once "../classes/domain/transactions.class.php";
...
$sec_to_min = new transactions();
$sec_to_min->condition = $dc_objects->condition;
$sec_to_min->order_by = $dc_objects->order_by;
$sec_to_min->add_condition("pozicija","<",$transactions->pozicija);
...
$sec_to_max = new transactions();
$sec_to_max->condition = $dc_objects->condition;
$sec_to_max->order_by = $dc_objects->order_by;
$sec_to_max->add_condition("pozicija",">",$transactions->pozicija);
...
<div id="container">
	<div id="top">
	<h1><?php echo $ap_lang["Preview"]; ?> - Transactions</h1>
...
<?php if($transactions->maker != ""){ ?>
<tr>
	<td><?php echo $ap_lang["Maker"]; ?></td>
	<td>
	<?php  echo $transactions->maker; ?> (<?php  echo $transactions->makerDate; ?>)
	</td>
</tr>
<?php } ?>
<?php if($transactions->checker != "" && $error_message == ""){ ?>
<tr>
	<td><?php echo $ap_lang["Checker"]; ?></td>
	<td>
	<?php  echo $transactions->checker; ?> (<?php  echo $transactions->checkerDate; ?>)
	</td>
</tr>
<?php } ?>
</table>
