...
require_once "../classes/domain/company_location_pass_rules.class.php";
...
$min_item = new company_location_pass_rules();
...
$sec_to_min = new company_location_pass_rules();
$sec_to_min->condition = $dc_objects->condition;
$sec_to_min->order_by = $dc_objects->order_by;
$sec_to_min->add_condition("pozicija","<",$company_location_pass_rules->pozicija);
...
$sec_to_max = new company_location_pass_rules();
$sec_to_max->condition = $dc_objects->condition;
$sec_to_max->order_by = $dc_objects->order_by;
$sec_to_max->add_condition("pozicija",">",$company_location_pass_rules->pozicija);
...
$max_item = new company_location_pass_rules();
...
<div id="container">
	<div id="top">
	<h1><?php echo $ap_lang["Preview"]; ?> - Company Location Pass Rules</h1>
